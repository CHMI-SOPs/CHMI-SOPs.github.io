...
tags: [library construction, microbiome]
keywords:
...
### Gel Electrophoresis
* A random row of wells should be selected from each PCR plate and run on a gel to confirm success of the PCR.
* Use 2 μl of sample, 4 μl of loading dye in a 1% agarose gel.
* Run at 100v for 30 minutes alongside a standard ladder.
* Photograph gel under UV. Check to be sure there is a band for every well. 
...
* Pool duplicate PCR reactions (20 μl + 20 μl for a total of 40 μl).

* Transfer 18 μl of pooled PCR product from plate to corresponding well on the normalization plate.

* Add 18 μl/well of Binding Buffer. Mix by pipetting, then seal, vortex, and spin briefly.
...
* Aspirate liquid from the wells, being careful not to scrape the sides of the wells.

* Add 50 μl of Wash Buffer and pipette up and down twice, then aspirate *immediately*. Ensure there is no residual wash buffer in any wells.

* Add 20 μl of Elution Buffer. Mix by pipetting up and down 5 times. Seal, vortex, and spin briefly.

* Incubate at room temperature for 5 minutes.

* Create a pool from each plate. Take 5 μl of each well to pool. The use of an empty 96-well plate may facilitate the use of multichannel pipettes.

* Freeze the remaining sample for later use.
...
* Use an extra long 100 μl tip with the pipettor set on 75 μl to transfer the 3 μl of Read 1 Sequencing Primer to the bottom of well 12 and pipette 10X to mix. Repeat this process spiking the Index Primer into well 13 and the Read 2 Sequencing Primer into well 14.

* Prepare a fresh dilution of 0.2N NaOH.

* To a 1.5ml tube add 10 μl of library, and 10 μl of 0.2N NaOH. To a separate tube add 2 μl PhiX, 3 μl PCR grade water, and 5 μl of 0.2N NaOH. Vortex both tubes to mix and spin for 1 minute at 400rcf. Note: NaOH concentration on the flow cell must remain under 0.001N. Adjusting the concentration of the NaOH used to denature the DNA to 0.1N may be necessary.

* Allow the tubes to incubate at room temperature for 5 minutes. Immediately add 980 μl of HT1 to the library tube, and 990 μl HT1 to the PhiX tube.

* Use HT1 to dilute both the library and PhiX to 10pM. For a 5% PhiX run, combine 950 μl of 3.5pM Library and 50 μl PhiX in a final tube. Vortex. Load 600 μl of this solution into well 17 on the reagent cartridge. See example below:
...
* Wet a new wipe with 100% alcohol and wipe the glass on both sides avoiding the rubber intake ports.
...
* deal parameters for a 95% 16S run:
