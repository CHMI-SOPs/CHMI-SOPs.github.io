...
| [Bandage](https://rrwick.github.io/Bandage/)                                 | genome assembly, visualization          | ```Bandage```                                                              |
...
| [bedtools](https://bedtools.readthedocs.io)                                 | handling HTS file formats          | ```bedtools```                                                              |
...
| [CheckM, GroopM, BamM](http://ecogenomics.github.io/CheckM/)                                                 | metagenomics, genome assembly                | ```checkm```, ```groopm```, ```bamm```                                                                              |
...
| [seqKit](https://github.com/shenwei356/seqkit)                                       | handling HTS file formats            | ```seqkit```                                                                               |
| [Sickle](https://github.com/najoshi/sickle)                            | quality trimming of raw sequences                | ```sickle se``` or ```sickle pe```                                                                               |
| [Sourmash](https://github.com/dib-lab/sourmash)                            | Compute and compare MinHash signatures for DNA data              | ```source activate sourmash```                                                                               |
